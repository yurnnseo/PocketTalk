...
public class MyProfileViewFrame extends JFrame {
    ...
    public MyProfileViewFrame(ClientFriendsMenuPanel parentMenuPanel, String username, String ip_addr, String port_no, String profileImagePath, String StatusM) {
        ...
        myProfileViewPanel = new MyProfileViewPanel(this, username, ip_addr, port_no, profileImagePath, StatusM);
